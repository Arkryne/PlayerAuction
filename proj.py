...
cursor = db.cursor()
create_table = "CREATE TABLE PLAYER (ID INT PRIMARY KEY NOT NULL,FNAME TEXT NOT NULL, LNAME TEXT NOT NULL, CATEGORY TEXT NOT NULL, BASEVALUE INT NOT NULL, TEAM CHAR(50), SOLDVALUE INT, PICTURE CHAR(50));"        
